                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu animated flipInX">
                            ...
                            <li role="separator" class="divider"></li>
                            <li><a href="select">教师查询</a></li>
                            <li role="separator" class="divider"></li>
                            <li><a href="add">增加教师</a></li>
                            <li class="active"><a href="change">变更教师</a></li>
                        </ul>
                    </li>
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true"
            ...
            <div class="panel-body">
                <form action="" method="post">
                    <div class="input-group">
                        ...
                        <input type="text" id="id" class="form-control" value="${requestScope.teacher.ID}"
                               placeholder="教师工号" aria-describedby="basic-addon1">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" id="name" class="form-control" value="${requestScope.teacher.name}"
                    ...
                    <div class="input-group">
                        ...
                        <input type="password" id="password" class="form-control"
                               value="${requestScope.teacher.password}" placeholder="密码"
                    ...
                    <div class="input-group">
                        ...
                        <input type="password" id="pwdagain" class="form-control"
                               value="${requestScope.teacher.password}" placeholder="再次输入密码"
                               aria-describedby="basic-addon1">
                    </div>
                    <br>
                    <div class="input-group">
                        ...
                        <div class="form-control">
                            <div class="row">
                                <label class="col-xs-5 col-sm-5 col-md-5 col-lg-5 col-xs-offset-1 col-sm-offset-1 col-md-offset-1 col-lg-offset-1">
                                    <input type="radio" name="sex" value="0" ${requestScope.teacher.sex?"":"checked"} >男
                                </label>
                                <label class="col-xs-5 col-sm-5 col-md-5 col-lg-5 col-xs-offset-1 col-sm-offset-1 col-md-offset-1 col-lg-offset-1">
                                    <input type="radio" name="sex" value="1" ${requestScope.teacher.sex?"checked":""}>女
                                </label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" id="department" class="form-control"
                               value="${requestScope.teacher.department}" placeholder="系别"
                               aria-describedby="basic-addon1">
                    </div>
                    <br>
...
<script>
    $(document).ready(function () {
        $("#inquiry").click(function () {
            ...
            if (id == "") {
                $("#modalLabel").html("错误");
                $("#modalBody").html("教师工号不能为空！");
                $('#modal').modal();
                return;
            }
            $.post(
                "changeTeacher/select",
                {"ID": id},
                function (back) {
                    ...
                    $("#name").val(back.teacher.name);
                    $("#password").val(back.teacher.password);
                    $("#pwdagain").val(back.teacher.password);
                    $(":radio[value=0]").prop("checked", !back.teacher.sex);
                    $(":radio[value=1]").prop("checked", back.teacher.sex);
                    $("#department").val(back.teacher.department);
                }
            );
        });
        $("#tijiao").click(function () {
            ...
            if (password == pwdagain) {
                $.post(
                    "updateTeacher",
                    {"ID": id, "name": name, "password": password, "sex": sex, "department": department},
                    function (modal) {
