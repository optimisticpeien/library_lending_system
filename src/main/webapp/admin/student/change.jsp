            ...
            <div class="panel-body">
                <form action="" method="post">
                    <div class="input-group">
                        ...
                        <input type="text" id="id" class="form-control" value="${requestScope.student.ID}"
                               placeholder="学号" aria-describedby="basic-addon1">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" id="name" class="form-control" value="${requestScope.student.name}"
                    ...
                    <div class="input-group">
                        ...
                        <input type="password" id="password" class="form-control"
                               value="${requestScope.student.password}" placeholder="密码"
                    ...
                    <div class="input-group">
                        ...
                        <input type="password" id="pwdagain" class="form-control"
                               value="${requestScope.student.password}" placeholder="再次输入密码"
                               aria-describedby="basic-addon1">
                    </div>
                    <br>
                    <div class="input-group">
                        ...
                        <div class="form-control">
                            <div class="row">
                                <label class="col-xs-5 col-sm-5 col-md-5 col-lg-5 col-xs-offset-1 col-sm-offset-1 col-md-offset-1 col-lg-offset-1">
                                    <input type="radio" name="sex" value="0" ${requestScope.student.sex?"":"checked"} >男
                                </label>
                                <label class="col-xs-5 col-sm-5 col-md-5 col-lg-5 col-xs-offset-1 col-sm-offset-1 col-md-offset-1 col-lg-offset-1">
                                    <input type="radio" name="sex" value="1" ${requestScope.student.sex?"checked":""}>女
                                </label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" id="department" class="form-control"
                               value="${requestScope.student.department}" placeholder="系别"
                               aria-describedby="basic-addon1">
                    </div>
                    <br>
                    <div class="input-group">
                        <div class="input-group-addon">班级</div>
                        <input type="text" id="grade" class="form-control" value="${requestScope.student.grade}"
                               placeholder="班级" aria-describedby="basic-addon1">
                    </div>
                    <br>
...
<script>
    $(document).ready(function () {
        $("#inquiry").click(function () {
            ...
            if (id == "") {
                $("#modalLabel").html("错误");
                $("#modalBody").html("学号不能为空！");
                $('#modal').modal();
                return;
            }
            $.post(
                "changeStudent/select",
                {"ID": id},
                function (back) {
                    ...
                    $("#name").val(back.student.name);
                    $("#password").val(back.student.password);
                    $("#pwdagain").val(back.student.password);
                    $(":radio[value=0]").prop("checked", !back.student.sex);
                    $(":radio[value=1]").prop("checked", back.student.sex);
                    $("#department").val(back.student.department);
                    $("#grade").val(back.student.grade);
                }
            );
        });
