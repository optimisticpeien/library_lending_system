...
<div class="container">
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu animated flipInX">
                            <li class="active"><a href="select">查询图书</a></li>
                            <li role="separator" class="divider"></li>
                            <li><a href="add">增加图书</a></li>
                            <li><a href="change">变更图书</a></li>
                        </ul>
                    </li>
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true"
                    ...
                    <div class="row">
                        ...
                        <div class=" col-xs-12 col-sm-5 col-md-3 col-lg-3 col-xs-offset-0 col-sm-offset-2 col-md-offset-0 col-lg-offset-0 ">
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                <div class="form-group">
                                    <label>单价</label>
                                    <input type="text" class="form-control" id="pricing" placeholder="单价">
                                </div>
                            </div>
                        </div>
                        <div class=" col-xs-12 col-sm-5 col-md-3 col-lg-3 col-xs-offset-0 col-sm-offset-0 col-md-offset-0 col-lg-offset-0 ">
                        ...
                        <div class=" col-xs-12 col-sm-5 col-md-3 col-lg-3 col-xs-offset-0 col-sm-offset-0 col-md-offset-0 col-lg-offset-0 ">
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                <div class="form-group">
                                    <label>
                                        <input type="checkbox" name="borrowCheck" value="1">能否借阅：
                                    </label>
                                    <div class="form-control">
                                        <label class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                                            <input type="radio" name="borrow" checked value="1">允许
                                        </label>
                                        <label class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                                            <input type="radio" name="borrow" value="0">禁止
                                        </label>
                                    </div>
                                </div>
                            </div>
    ...
    <div class="animated fadeInUp">
        <div class="panel panel-success">
            ...
            <table class="table table-condensed" id="booksTable" style="cursor:pointer">
                <tbody>
                <tr class="books">
                    <th>ISBN</th>
                    <td>ISBN</td>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $("#select").click(function () {
            ...
            pricingCheck = !(pricing == "" || pricing == 0);
            numberCheck = !(number == "" || number == 0);
            $("input[name='borrowCheck']").each(function () {
                if ($(this).is(':checked') == true) {
                    borrowCheck = true;
                    borrow = $("input[name='borrow']:checked").val() == 1;
                } else {
                    borrowCheck = false;
                }
            });
    ...
    function pageJmp(p) {
        ...
        $.post(
            "selectBook",
            {
                "ISBN": ISBN, "name": name, "author": author, "press": press, "type": type, "pricing": pricing,
                "number": number, "borrow": borrow, "introduction": introduction,
                "pricingCheck": pricingCheck, "numberCheck": numberCheck, "borrowCheck": borrowCheck,
            ...
            function (map) {
                ...
                for (let i = 0; i < long; i++) {
                    $("#booksTable").append("\n" +
                        ...
                        "                <tr class=\"books\">\n" +
                        "                    <th>单价</th>\n" +
                        "                    <td>" + map.books[i].pricing + "</td>\n" +
                        "                    <th>数量</th>\n" +
                        "                    <td>" + map.books[i].number + "</td>\n" +
                        "                    <th>能否借阅</th>\n" +
                        "                    <td>" + ((map.books[i].borrow) ? "是" : "否") + "</td>\n" +
                        "                </tr>\n" +
                        "                <tr class=\"books\">\n" +
                        "                    <th>简介</th>\n" +
                ...
                $("#booksTable tbody").click(function () {
                    ...
                    //    alert(tdid);
                    window.location.href = "change?ISBN=" + tdid;
                });
                $(".pageNumber").remove();
                if (pageNumber != 0) {
                    if (page == 1) {
