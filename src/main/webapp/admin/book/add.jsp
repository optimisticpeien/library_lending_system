...
<div class="container">
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu animated flipInX">
                            ...
                            <li class="active"><a href="add">增加图书</a></li>
    ...
    <div class="col-xs-12 col-sm-12 col-md-10 col-lg-8 col-md-offset-1 col-lg-offset-2 animated fadeInUp">
        <div class="panel panel-success">
            <div class="panel-heading">图书入档</div>
            <div class="panel-body">
                <form class="form-horizontal">
                    <div class="form" id="form">
                        <div class="input-group book">
                            <div class="input-group-addon">图书编号</div>
                            <input type="text" class="form-control" id="ISBN" placeholder="ISBN号"
                        ...
                        <div class="input-group book">
                            ...
                            <input type="text" class="form-control" id="pricing" placeholder="定价"
                                   aria-describedby="basic-addon1">
                        </div>
                        <br>
                        <div class="input-group book">
                            <div class="input-group-addon">&ensp;总本数&ensp;</div>
                            <input type="text" class="form-control" id="number" placeholder="总本数"
                                   aria-describedby="basic-addon1">
                        </div>
                        <br>
                            ...
                            <div class="form-control">
                                <div class="row">
                                    <label class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                                        <input type="checkbox" name="borrow" checked>可借阅
                                    </label>
                                </div>
                            </div>
                        </div>
                        <br>
                        <label>内容简介</label>
                        <textarea class="form-control" id="introduction" placeholder="内容简介" rows="3"></textarea>
                        <br class="bookbr">
                    </div>
